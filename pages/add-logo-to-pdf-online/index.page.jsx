...
function AddLogoToPdfOnlinePage() {
        ...
        },
        {
            ...
            a: (
                <>
                    ...
                    <a href="/compress-pdf/" className="text-primary-600 hover:underline">compress it for email</a>{" "}
                    or{" "}
                    <a href="/sign-pdf/" className="text-primary-600 hover:underline">sign it</a>.
                </>
            ),
        },
    ];
  ...
  <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2161679270376605" crossOrigin="anonymous" />
            ...
            <main className="flex-1">
                ...
                <section className="py-14 bg-[#091328]/50 backdrop-blur-xl border border-white/5">
                    <div className="max-w-5xl mx-auto px-6">
                        <h2 className="text-2xl font-bold text-on-surface font-headline mb-4">
                ...
                <section className="py-14 bg-[#091328]/50">
                    <div className="max-w-4xl mx-auto px-6">
                        <h2 className="text-3xl font-bold text-on-surface font-headline mb-6">Add Logo to PDF — FAQs</h2>
                ...
                <section className="py-14 bg-[#091328]/50 backdrop-blur-xl border border-white/5">
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 text-primary-700">
                            <li><a href="/add-image-pdf/" className="underline hover:text-primary-900">Add image to PDF</a></li>
                        ...
                        <div className="mt-6 text-sm text-on-surface-variant">
                            ...
                            <a href="/type-on-pdf-document/" className="text-primary-700 underline hover:text-primary-900">type on the PDF</a>{" "}
