                        ...
                        <div className="bg-white border rounded-2xl shadow p-4">
                            ...
                            <div className="mt-4 bg-gray-50 border rounded-xl p-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="font-semibold text-gray-900 mb-1">Best results (screenshots win)</p>
                    ...
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-5">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-1">No fluff — accuracy depends on the image</h3>
