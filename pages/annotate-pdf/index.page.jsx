        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-amber-50 via-white to-blue-50">
          <div className="max-w-6xl mx-auto px-6 py-14 md:py-16 grid md:grid-cols-2 gap-10 items-center">
            <div className="space-y-4 text-center md:text-left">
              <p className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border text-xs font-semibold text-amber-700">
              ...
              <div className="flex flex-wrap gap-3 justify-center md:justify-start text-sm text-gray-700">
                <span className="inline-flex items-center gap-2 bg-white border px-3 py-2 rounded-lg shadow-sm">
                  <Highlighter className="h-4 w-4 text-amber-500" /> Freeform highlights
                </span>
                <span className="inline-flex items-center gap-2 bg-white border px-3 py-2 rounded-lg shadow-sm">
                  <MessageSquare className="h-4 w-4 text-blue-500" /> Sticky notes &amp; comments
                </span>
              </div>
            </div>
