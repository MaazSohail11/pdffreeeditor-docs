  ...
  return (
    <div className="font-sans bg-gradient-to-br from-blue-50 via-slate-50 to-indigo-50 text-gray-900 min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero / intro */}
        <section className="bg-white/80 border-b">
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-14 space-y-6 text-sm sm:text-base">
          <p className="text-gray-700">
            ...
            ,{" "}
            <a href="/merge-pdf/" className="text-blue-600 hover:underline">
              Merge PDF
            </a>
            ,{" "}
            <a href="/sign-pdf/" className="text-blue-600 hover:underline">
              Sign PDF
            </a>{" "}
            ...
            and{" "}
            <a href="/pdf-to-image/" className="text-blue-600 hover:underline">
              PDF to Image
            </a>
            ).
          </p>
