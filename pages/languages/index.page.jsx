...
function OCRLanguagesPage() {
  ...
  <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2161679270376605" crossOrigin="anonymous" />
                ...
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-8 items-start">
                    <div className="text-center lg:text-left">
                        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-4">
                            ...
                            <br />
                            <span className="text-blue-600">Choose the right language for better accuracy</span>
                        </h1>
                        ...
                        <div className="bg-white border rounded-2xl p-5 shadow-sm mb-6">
                            ...
                            <div className="grid sm:grid-cols-2 gap-3">
                                {supported.map((l) => (
                                    <div key={l.name} className="bg-gray-50 border rounded-xl p-4 text-left">
                                        <div className="flex items-start gap-3">
                                            <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                                            <div>
                                                <p className="font-semibold text-gray-900">
                                                    {l.name} <span className="text-gray-500 font-normal">({l.native})</span>
                                                </p>
                                                <p className="text-sm text-gray-600">Common: {l.example}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                    ...
                    <aside id="try" className="lg:sticky lg:top-6">
                        <div className="bg-white border rounded-2xl shadow p-4">
                            ...
                            <div className="mt-4 bg-gray-50 border rounded-xl p-4">
                                <p className="font-semibold text-gray-900 mb-1">Long PDF or page cap?</p>
            ...
            <main className="flex-1">
                ...
                {/* Choose language */}
                <section id="choose" className="py-12 bg-gray-50">
                    <div className="max-w-5xl mx-auto px-6">
                        <h2 className="text-2xl font-bold mb-6">How to choose the best OCR language (fast rules)</h2>

                        <div className="grid md:grid-cols-3 gap-4">
                            {quickRules.map((r) => (
                                <div key={r.title} className="bg-white border rounded-xl p-5 shadow-sm">
                                    <div className="flex items-start gap-3">
                                        <r.icon className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                                        <div>
                ...
                <section className="py-12 bg-white">
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 text-blue-700">
                            ...
                            <li><a href="/why-ocr-improves-searchability/" className="underline hover:text-blue-900">What is OCR in PDF?</a></li>
