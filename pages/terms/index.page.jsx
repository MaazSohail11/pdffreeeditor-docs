...
function Terms() {
  return (
    <div className="font-sans bg-[#091328]/50 backdrop-blur-xl border border-white/5 text-on-surface font-headline">
      <Helmet>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p>
          For questions, see our <a href="/privacy/" className="text-primary-600 underline">Privacy Policy</a> or
          <a href="/contact/" className="text-primary-600 underline"> Contact</a> page.
        </p>
