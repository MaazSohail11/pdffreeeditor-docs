        ...
        <section className="bg-gradient-to-br from-blue-50 to-indigo-50 py-16">
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8 items-start">
            <div className="text-center md:text-left">
              ...
              <p className="text-lg text-gray-700">Export PDF pages as JPG/PNG in seconds. No login. No watermark.</p>
        ...
        <section id="faq" className="max-w-4xl mx-auto px-6 pb-16">
          ...
          <div className="space-y-3">
            ...
            <details className="bg-white border rounded p-4">
              ...
              <p className="mt-2 text-gray-700">Export to JPG or PNG, great for sharing on social or embedding on web pages.</p>
            </details>
            <details className="bg-white border rounded p-4">
              <summary className="font-semibold cursor-pointer">Is it secure?</summary>
              <p className="mt-2 text-gray-700">Processing runs in your browser where possible for privacy.</p>
            </details>
          </div>
        </section>
      </main>
