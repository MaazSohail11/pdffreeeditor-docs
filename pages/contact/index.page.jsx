  ...
  return (
    <div className="font-sans bg-gradient-to-br from-primary-50 via-slate-50 to-primary-50 text-on-surface font-headline min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="border-b bg-[#091328]/50 backdrop-blur-xl border border-white/5/70 backdrop-blur-sm">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="grid sm:grid-cols-2 gap-6">
                {/* General contact */}
                <div className="bg-[#091328]/50 backdrop-blur-xl border border-white/5 rounded-xl shadow-[0_0_15px_rgba(139,92,246,0.1)] border border-white/5 p-5 sm:p-6">
                  ...
                  <a
                    ...
                    className="inline-flex items-center text-primary-600 font-medium hover:text-primary-700 hover:underline break-all"
                  >
                ...
                <div className="bg-[#091328]/50 backdrop-blur-xl border border-white/5 rounded-xl shadow-[0_0_15px_rgba(139,92,246,0.1)] border border-white/5 p-5 sm:p-6">
                  ...
                  <ul className="mt-3 text-xs text-outline list-disc pl-4 space-y-1">
            ...
            <aside className="space-y-6">
              ...
              <div className="bg-[#091328]/50 backdrop-blur-xl border border-white/5 rounded-xl shadow-[0_0_15px_rgba(139,92,246,0.1)] border border-dashed border-white/5 p-4">
                <h3 className="text-sm font-semibold mb-1 text-on-surface font-headline">
                  Response time
                </h3>
