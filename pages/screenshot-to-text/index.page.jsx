                ...
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-8 items-start">
                    <div className="text-center lg:text-left">
                        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-4">
                            ...
                            <br />
                            <span className="text-blue-600">Extract Text from Screenshot Images • Copy Instantly</span>
                        </h1>
                        ...
                        <div className="bg-white border rounded-2xl shadow p-4">
                            ...
                            <div className="mt-4 bg-gray-50 border rounded-xl p-4">
                                <div className="flex items-start gap-3">
                                    <Crop className="h-5 w-5 text-blue-600 mt-1 flex-shrink-0" />
                                    <div>
            ...
            <main className="flex-1">
                    ...
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-5">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-1">No hype: OCR depends on image quality</h3>
                ...
                <section className="py-12 bg-white">
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                            ...
                            <div className="bg-gray-50 border rounded-xl p-6">
                                <h3 className="font-semibold text-gray-900 mb-2">Windows 11</h3>
                                <p className="text-gray-600">
                ...
                <section className="py-16 bg-blue-600 text-center">
                    <div className="max-w-3xl mx-auto px-6">
                        <h2 className="text-3xl font-bold text-white mb-2">Extract text from a screenshot now</h2>
