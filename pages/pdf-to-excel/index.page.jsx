        ...
        <section className="digital-obsidian text-on-surface py-16">
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8 items-start">
            <div className="text-center md:text-left">
              ...
              <p className="text-lg text-on-surface-variant">Extract tables from PDF to XLSX or CSV in seconds. No login. No watermark.</p>
        ...
        <section id="faq" className="max-w-4xl mx-auto px-6 pb-16">
          ...
          <div className="space-y-3">
            ...
            <details className="bg-[#091328]/50 backdrop-blur-xl border border-white/5 rounded p-4">
              ...
              <p className="mt-2 text-on-surface-variant">We aim for high accuracy. Review detected tables and adjust if needed before export.</p>
            </details>
            <details className="bg-[#091328]/50 backdrop-blur-xl border border-white/5 rounded p-4">
              <summary className="font-semibold cursor-pointer">Is it secure?</summary>
              <p className="mt-2 text-on-surface-variant">Processing runs in your browser where possible so your data stays private.</p>
            </details>
          </div>
        </section>
      </main>
